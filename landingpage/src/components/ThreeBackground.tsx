...
const ThreeBackground: React.FC<ThreeBackgroundProps> = ({
    ...
    useEffect(() => {
        ...
        if (variant === 'particles') {
            ...
            const color1 = new THREE.Color(0xa3e635); // Matcha Lime
            const color2 = new THREE.Color(0x4ade80); // Leaf Green
            ...
            const nodeMaterial = new THREE.MeshBasicMaterial({ color: 0xa3e635 });
