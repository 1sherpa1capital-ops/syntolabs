                    ...
                    <form onSubmit={handleSubmit} className="max-w-md mx-auto relative">
                        <div className="relative group">
                            ...
                            <button
                                ...
                                className="absolute right-1.5 top-1.5 bottom-1.5 px-6 rounded-full bg-accent hover:bg-cta-hover text-white font-bold text-sm transition-all disabled:opacity-70 disabled:cursor-not-allowed flex items-center gap-2"
                            >
                                {status === 'loading' ? (
