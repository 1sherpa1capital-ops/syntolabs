  ...
  return (
    <CalProvider>
      <BookingProvider>
        ...
        <section className="py-32">
          <div className="mx-auto max-w-3xl px-6">
            <h2 className="text-3xl md:text-4xl font-semibold mb-8 text-white text-center">
              Two ways to book
            </h2>
            <p className="text-lg text-zinc-400 mb-8 max-w-3xl text-center">
              Test both Cal.com integration approaches: modal popup (above) and inline embed (below).
            </p>
            <InlineBookingDemo />
          </div>
        </section>
